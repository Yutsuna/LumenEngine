...
LumenEngine::Lumen::FToken LumenEngine::Lumen::FToken::Make ( EType InType, FStringView InText, USize InLine ) noexcept
{
...
LumenEngine::Lumen::FDLSLScanner::FDLSLScanner ( FStringView InSource ) noexcept : Source( InSource )
{
    /* Ctor */
}

LumenEngine::Bool LumenEngine::Lumen::FDLSLScanner::IsAtEnd () const noexcept
{
    return Cursor >= Source.size();
}

LumenEngine::AnsiChar LumenEngine::Lumen::FDLSLScanner::Peek () const noexcept
{
    if ( IsAtEnd() )
    {
        return '\0';
...
void LumenEngine::Lumen::FDLSLScanner::SkipWhitespace () noexcept
{
    while ( not IsAtEnd() )
    {
...
LumenEngine::Lumen::FToken LumenEngine::Lumen::FDLSLScanner::ScanToken () noexcept
{
    SkipWhitespace();
...
LumenEngine::Lumen::FToken LumenEngine::Lumen::FDLSLScanner::ScanStringToken ( USize InStartIndex ) noexcept
{
...
LumenEngine::Lumen::FToken LumenEngine::Lumen::FDLSLScanner::ScanIdentifierToken ( USize InStartIndex ) noexcept
{
...
LumenEngine::Lumen::FToken LumenEngine::Lumen::FDLSLScanner::ScanNumberToken ( USize InStartIndex ) noexcept
{
    while ( IsDigit( Peek() ) )
    {
        Advance();
