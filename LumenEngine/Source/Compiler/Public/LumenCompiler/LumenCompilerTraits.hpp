...
namespace Compiler
{
     ...
     *
     * Each static method is called by TCompilerCache<> to build paths, validate
     * metadata, and restore or create cached entries — mirroring the pattern
     * established by FShaderCompilerTraits.
     */
    struct FLumenCompilerTraits
    {
